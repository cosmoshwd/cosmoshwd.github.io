...
function getWebGLContext(e) {
  var r,
    t,
    n = { alpha: !0, depth: !1, stencil: !1, antialias: !1, preserveDrawingBuffer: !1 },
    i = e.getContext("webgl2", n),
    o = !!i;
  o || (i = e.getContext("webgl", n) || e.getContext("experimental-webgl", n)),
    (t = o
      ? (i.getExtension("EXT_color_buffer_float"), i.getExtension("OES_texture_float_linear"))
      : ((r = i.getExtension("OES_texture_half_float")), i.getExtension("OES_texture_half_float_linear"))),
    i.clearColor(0, 0, 0, 1);
  var a,
    l,
    u,
    c = o ? i.HALF_FLOAT : r.HALF_FLOAT_OES;
  return (
    (u = o
      ? ((a = getSupportedFormat(i, i.RGBA16F, i.RGBA, c)), (l = getSupportedFormat(i, i.RG16F, i.RG, c)), getSupportedFormat(i, i.R16F, i.RED, c))
      : ((a = getSupportedFormat(i, i.RGBA, i.RGBA, c)), (l = getSupportedFormat(i, i.RGBA, i.RGBA, c)), getSupportedFormat(i, i.RGBA, i.RGBA, c))),
    { gl: i, ext: { formatRGBA: a, formatRG: l, formatR: u, halfFloatTexType: c, supportLinearFiltering: t } }
  );
}
...
function resizeDoubleFBO(e, r, t, n, i, o, a) {
  return (
    (e.width == r && e.height == t) ||
      ((e.read = resizeFBO(e.read, r, t, n, i, o, a)), (e.write = createFBO(r, t, n, i, o, a)), (e.width = r), (e.height = t), (e.texelSizeX = 1 / r), (e.texelSizeY = 1 / t)),
    e
  );
}
...
function multipleSplats(e) {
  for (var r = 0; r < e; r++) {
    var t = generateColor();
    (t.r *= 10), (t.g *= 10), (t.b *= 10), splat(Math.random(), Math.random(), 1e3 * (Math.random() - 0.5), 1e3 * (Math.random() - 0.5), t);
  }
}
